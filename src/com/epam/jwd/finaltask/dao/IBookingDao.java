...
public interface IBookingDao {
    ...
    void create(String checkInDate, String checkOutDate, int adultsCount, int childrenCount, String comment, int roomTypeId, int guestId, int rateTypeId, int typeId, int guestTypeId) throws DAOException;
