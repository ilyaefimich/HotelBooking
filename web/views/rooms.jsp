...
<div class="container-fluid"
    ...
    <form method="POST" action="./controller?command=getRoomDetails&mode=create">
        <div class="row">
            <div class="col-xs-12">
                <div class="text-right">
                    <input type="submit" value="<fmt:message key="page.add_room"/>"
    ...
    <table class="table">
        ...
        <tr>
            ...
            <th><fmt:message key="page.Room_Type"/></th>
        </tr>
        </thead>
        <tbody>
        <c:forEach var="room" items="${rooms}" varStatus="index">
            <tr>
                ...
                <td>
                    <form method="POST" action="./controller?command=getRoomDetails&mode=update">
                ...
                <td>
                    ...
                    <a href="#confirm-delete"
                       data-href="./controller?command=deleteroom&roomid=${room.roomId}"
